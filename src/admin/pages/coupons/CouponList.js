...
const CouponList = (props) => {
  ...
  useEffect(() => {
    ...
    let url = `${Config.SERVER_URL}/coupons?skip=${pagination.skip}&limit=${pagination.limit}&status=${status}`;
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/coupons?skip=0&limit=0&status=${status}`;
    if (searchQuery) url += `&searchQuery=${searchQuery}`;
    fetch(url, {
      method: "GET",
      headers: {
                          ...
                          {allCoupon.map((coupon, index) => {
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td>{coupon.numberOfUsesTimes}</td>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/coupon/edit/${coupon.id}`,
                                    }}
                                  >
                                    <span
