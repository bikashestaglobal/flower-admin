...
const CustomerList = (props) => {
  ...
  useEffect(() => {
    ...
    let url = `${Config.SERVER_URL}/customers?skip=${pagination.skip}&limit=${pagination.limit}&status=${status}`;
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/customers?skip=0&limit=0&status=${status}`;
    if (searchQuery) url += `&searchQuery=${searchQuery}`;
    if (isVerified) url += `&isVerified=${isVerified}`;
    fetch(url, {
      method: "GET",
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/customer/edit/${customer.id}`,
                                    }}
                                  >
                                    <span
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/customer/show/${customer.id}`,
                                    }}
                                    title="Show"
                                  >
                                    <span
