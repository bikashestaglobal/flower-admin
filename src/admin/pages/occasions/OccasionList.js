...
const OccasionList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/occasions/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    setDataLoaded(false);
    let url = `${Config.SERVER_URL}/occasions?skip=${pagination.skip}&limit=${pagination.limit}&status=${status}`;
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/categories?skip=${pagination.skip}&limit=${pagination.limit}&status=${status}`;
    if (searchQuery) url += `&searchQuery=${searchQuery}`;
    fetch(url, {
      method: "GET",
      headers: {
  ...
  return (
    <div className="page-wrapper px-0 pt-0">
      <div className={"container-fluid"}>
        ...
        <Breadcrumb title={"OCCASSIONS"} pageTitle={"Occasion List"} />
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-right">
                    <Link
                      ...
                      to={{
                        pathname: "/admin/occasion/addByCSV",
                      }}
                    >
                    ...
                    <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/admin/occasion/editByCSV",
                      }}
                    >
                    ...
                    <Link
                      to={"/admin/occasion/add"}
                      className={"btn btn-info "}
                    >
                      <span className={"fas fa-plus"}></span> Occasion
                    </Link>
                  </div>
                </div>
              </div>
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={`/admin/occasion/edit/${data._id}`}
                                  >
                                    <span
