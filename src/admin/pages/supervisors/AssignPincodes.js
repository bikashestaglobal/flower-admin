...
const AssignPincodes = (props) => {
  ...
  const selectPincodeHandler = (deliveryBoyId) => {
    if (formData.length) {
    ...
    const getData = async () => {
      try {
        ...
        if (result.status == 200) {
          const pincodesArray = result?.body?.pincodes.map((pincode) => {
            return pincode._id;
          });
          setFormData([...pincodesArray]);
        } else {
  ...
  // Get Pincodes
  useEffect(() => {
    let url = `${Config.SERVER_URL}/pincodes/getAllNotAssigned?skip=0&limit=$0`;
  ...
  return (
    <div className="page-wrapper px-0 pt-0">
      <div className={"container-fluid"}>
        ...
        <Breadcrumb title={"PINCODES"} pageTitle={"Assign Pincodes"} />
                    ...
                    <div className={"card-body pb-0 pt-2 d-flex"}>
                      ...
                      <div className="border px-2">
                        <input
                          ...
                          placeholder="By Pincode/State/City"
