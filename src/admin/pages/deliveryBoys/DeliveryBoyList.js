...
const DeliveryBoyList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/deliveryBoys/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    setDataLoaded(false);
    let url = `${Config.SERVER_URL}/deliveryBoys?skip=${pagination.skip}&limit=${pagination.limit}&status=${status}`;
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/deliveryBoys?skip=0&limit=0&status=${status}`;
    if (searchQuery) url += `&searchQuery=${searchQuery}`;
    fetch(url, {
      method: "GET",
      headers: {
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-right">
                    <Link
                      ...
                      to={{
                        pathname: "/admin/deliveryBoy/add",
                      }}
                    >
                      <span className={"fas fa-plus"}></span> Delivery Boy
                    </Link>
                  </div>
                </div>
              </div>
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/deliveryBoy/edit/${vendor.id}`,
                                    }}
                                  >
                                    <span
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/deliveryBoy/dashboard/${vendor.id}`,
                                    }}
                                  >
                                    <span
