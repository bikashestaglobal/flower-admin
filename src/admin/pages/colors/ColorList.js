...
const ColorList = (props) => {
  ...
  const [isAllColorLoaded, setIsAllColorLoaded] = useState(false);
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/color/${deleteId}`, {
      method: "DELETE",
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/branch/color/edit/${color._id}`,
                                    }}
                                  >
                                    <span
