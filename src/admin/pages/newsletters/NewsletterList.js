...
const NewsletterList = (props) => {
  ...
  useEffect(() => {
    setLoading(true);
    let url = `${Config.SERVER_URL}/newsletters?skip=${pagination.skip}&limit=${pagination.limit}&status=${status}`;
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/newsletters?skip=0&limit=0&status=${status}`;
    if (searchQuery) url += `&searchQuery=${searchQuery}`;
    fetch(url, {
      method: "GET",
      headers: {
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/newsletter/edit/${email.id}`,
                                    }}
                                  >
                                    <span
                                  ...
                                  <Link
                                    ...
                                    // to={{
                                    //   pathname: `/admin/newsletter/show/${email.id}`,
                                    // }}
                                    title="Show"
                                  >
                                    <span
