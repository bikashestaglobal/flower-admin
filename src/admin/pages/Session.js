...
const Session = React.memo((props) => {
  ...
  const updateSubmitHandler = (evt) => {
    ...
    evt.preventDefault();
    fetch(Config.SERVER_URL + "/branch/updateSession", {
      method: "PUT",
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(Config.SERVER_URL + "/branch/deleteSession", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/branch/addSession", {
      method: "POST",
  ...
  useEffect(() => {
    fetch(Config.SERVER_URL + "/branch/searchSession", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
        ...
        return (
          <div>
            ...
            <button
              ...
              onClick={(evt) => branchSessionHandler(row.row.original._id)}
            >
              <span
