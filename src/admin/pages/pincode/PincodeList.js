...
const PincodeList = (props) => {
  ...
  const [isAllPincodeLoaded, setIsAllPincodeLoaded] = useState(false);
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/pincodes/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    ...
    let url = `${Config.SERVER_URL}/pincodes?skip=${pagination.skip}&limit=${pagination.limit}&status=${status}`;
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/pincodes?skip=0&limit=0&status=${status}`;
    if (searchQuery) url += `&searchQuery=${searchQuery}`;
    fetch(url, {
      method: "GET",
      headers: {
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-right">
                    <Link
                      ...
                      to={{
                        pathname: "/admin/pincode/addByCSV",
                      }}
                    >
                    ...
                    <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/admin/pincode/editByCSV",
                      }}
                    >
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/pincode/edit/${pincode.id}`,
                                    }}
                                  >
                                    <span
