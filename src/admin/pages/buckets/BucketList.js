...
const BucketList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/buckets/${deleteId}`, {
      method: "DELETE",
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-right">
                    <Link
                      ...
                      to={{
                        pathname: "/admin/bucket/addByCSV",
                      }}
                    >
                    ...
                    <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/admin/bucket/editByCSV",
                      }}
                    >
                      <span className={"fas fa-edit"}></span> Update By CSV
                    </Link>

                    <Link to={"/admin/bucket/add"} className={"btn btn-info "}>
                      <span className={"fas fa-plus"}></span> Bucket
                    </Link>
                  </div>
                </div>
              </div>
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/bucket/edit/${bucket.id}`,
                                    }}
                                  >
                                    <span
