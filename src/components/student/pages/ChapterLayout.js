...
function ChapterLayout() {
  ...
  const [chapterLayoutLoaded, setChapterLayoutLoaded] = useState(false);
  ...
  useEffect(() => {
    ...
    fetch(Config.SERVER_URL + "/student/searchChapterLayouts?session=" + sessionId + "&batch=" + batchId, {
      method: "GET",
      headers: {
