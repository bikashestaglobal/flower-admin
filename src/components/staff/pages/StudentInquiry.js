...
const StudentInquiry = (props) => {
  ...
  const updateSubmitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/staff/updateInquiredStudent", {
      method: "PUT",
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(Config.SERVER_URL + "/staff/deleteInquiredStudent", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    evt.preventDefault();
    fetch(Config.SERVER_URL + "/staff/addInquiry", {
      method: "POST",
  ...
  useEffect(() => {
    ...
    fetch(
      Config.SERVER_URL + "/staff/searchInquiredStudent?session=" + selectedSession,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
            ...
            <div className={"card mb-0 mt-2 border-0 rounded-0"}>
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  {state && state.student.addInquiry ?
                    <button
                      type="button"
                            ...
                            return (
                              <tr key={result._id}>
                                ...
                                <td className={"text-center"}>
                                  ...
                                  >
                                    {/* View Button */}
                                    {state && state.student.showPersonalInquiryDetails ?
                                      <button
                                        type="button"
                                    ...
                                    {/* Update Button */}
                                    {state && state.student.updateInquiry ? <button
                                      type="button"
                                    ...
                                    {/* Delete Button */}
                                    {state && state.student.deleteInquiry ?
                                      <button
                                        type="button"
                                    ...
                                    {state && state.student.updateInquiryStatus ?
                                      <button
                                        type="button"
                                    ...
                                    {/*Send SMS Button */}
                                    {state && state.student.sendInquiryMessage ?
                                      <button
                                        type="button"
