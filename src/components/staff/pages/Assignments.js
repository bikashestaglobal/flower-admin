...
//  Component Function
const Assignments = React.memo((props) => {
  ...
  // const [isallAssignmentsLoaded, setIsallAssignmentsLoaded] = useState(true);
  ...
  const deleteSubmitHandler = async () => {
    ...
    fetch(Config.SERVER_URL + "/staff/deleteAssignment", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/staff/addAssignment", {
      method: "POST",
  ...
  useEffect(() => {
    // setIsallAssignmentsLoaded(true);
    fetch(Config.SERVER_URL + "/staff/searchAssignment?session=" + selectedSession, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_staff_token")}`,
      ...
      .then(
        (result) => {
          // setIsallAssignmentsLoaded(false);
          if (result.success) {
      ...
      Cell: ({ row }) => {
        ...
        return (
          <div>
            ...
            {/* update button */}
            {state && state.classRoomAsset.updateAssignment ? <button
              type="button"
            ...
            {/* show button */}
            {state && state.classRoomAsset.showSingleAssignment ? <button
              type="button"
            ...
            {/* delete button */}
            {state && state.classRoomAsset.deleteAssignment ? <button
              type="button"
  ...
  const rows_data = useMemo(() => allAssignments, [allAssignments]);
      ...
      <div className={"container-fluid"}>
        ...
        <div className="row page-titles">
          <div className="col-md-5 col-8 align-self-center">
            <h3 className="text-themecolor m-b-0 m-t-0">Assignments</h3>
            ...
            <div className={"card mb-0 mt-2 border-0 rounded-0"}>
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  {state && state.classRoomAsset.addAssignment ? <button
                    type="button"
