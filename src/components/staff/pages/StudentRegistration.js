...
const StudentRegistration = (props) => {
  ...
  const updateSubmitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/staff/updateStudent", {
      method: "PUT",
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(Config.SERVER_URL + "/staff/deleteStudent", {
      method: "DELETE",
  ...
  const submitHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/staff/addStudent", {
      method: "POST",
      body: JSON.stringify(studentData),
      headers: {
        "Content-Type": "application/json",
  ...
  const makePaymentHandler = (evt) => {
    ...
    fetch(Config.SERVER_URL + "/staff/makePayment", {
      method: "POST",
      body: JSON.stringify(studentData),
      headers: {
        "Content-Type": "application/json",
  ...
  useEffect(() => {
    ...
    fetch(
      Config.SERVER_URL + "/staff/searchBatch?session=" + selectedSession,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    // Get All Standard
    fetch(
      Config.SERVER_URL + "/staff/searchStandard?session=" + selectedSession,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    // Get All CourseType
    fetch(
      Config.SERVER_URL + "/staff/searchCourseType?session=" + selectedSession,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    // Get All Student
    fetch(
      Config.SERVER_URL + "/staff/searchStudent?session=" + selectedSession,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    },
    {
      ...
      Cell: ({ row }) => {
        ...
        return (
          <div>
            {/* Edit Button */}
            {state && state.student.updateRegistration ? <button
              type="button"
            ...
            {/* View Button */}
            {state && state.student.showPersonalStudentDetails ?
              <button
                type="button"
            ...
            {/* Payment Button */}
            {state && state.student.addPayment ?
              <button
                type="button"
                className="ml-2 btn btn-primary p-1"
                data-toggle="modal"
                data-target="#makePaymentModal"
                onClick={(evt) => updateStateForPayment(row.original)}
              >
                <span
            ...
            {/* Delete Button */}
            {state && state.student.deleteRegistration ?
              <button
                type="button"
            ...
            <div className={"card mb-0 mt-2 border-0 rounded-0"}>
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  {state && state.student.addRegistration ? <button
                    type="button"
