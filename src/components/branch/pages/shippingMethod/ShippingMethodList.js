...
const ShippingMethodList = (props) => {
  ...
  const [isAllShippingMethodLoaded, setIsAllShippingMethodLoaded] =
    useState(false);
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/shipping-method/${deleteId}`, {
      method: "DELETE",
    ...
    fetch(
      ...
      .then(
        (result) => {
          ...
          if (result.status === 200) {
            setAllShippingMethod(result.body || []);
          } else {
            M.toast({ html: result.message, classes: "bg-danger" });
          }
        },
      ...
      <div className={"container-fluid"}>
        ...
        >
          <div className={"col-md-12 px-0"}>
            ...
            {/* Data */}
            {isAllShippingMethodLoaded ? (
              <div className="card border-0 rounded m-0 py-1">
                {allShippingMethod.length ? (
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/branch/shippingMethod/edit/${method.id}`,
                                    }}
                                  >
                                    <span
