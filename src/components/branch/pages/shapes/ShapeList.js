...
const ShapeList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/shape/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    setIsAllShapeLoaded(false);
    fetch(
      `${Config.SERVER_URL}/shape?skip=${pagination.skip}&limit=${
        pagination.limit
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/shape?skip=0&limit=0&searchQuery=${
        searchQuery || null
      }`,
      {
        method: "GET",
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-right">
                    <Link
                      ...
                      to={{
                        pathname: "/branch/shape/addByCSV",
                      }}
                    >
                    ...
                    <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/branch/shape/editByCSV",
                      }}
                    >
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/branch/shape/edit/${shape.id}`,
                                    }}
                                  >
                                    <span
