...
const ParentCategory = (props) => {
  ...
  const updateSubmitHandler = (evt) => {
    ...
    fetch(`${Config.SERVER_URL}/parent-category/${data._id}`, {
      method: "PUT",
  ...
  const imgDeleteHandler = (image) => {
    ...
    fileRef
      ...
      .then(() => {
        ...
        fetch(`${Config.SERVER_URL}/parent-category/${data.id}`, {
          method: "PUT",
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/parent-category?skip=${pagination.skip}&limit=${pagination.limit}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
            ...
            <div className="modal-dialog modal-xl" role="document">
              <div className="modal-content rounded">
                <div className="modal-body">
                  <h4 className={"text-theme"}>Add Parent Category</h4>
